defmodule GameEngine.EngineControllerTest do
	...
	test "returns new game when initializing based on Engine" do
		game_type = GameEngine.GameType.computer_computer
		with_mock GameEngine.Engine, [:passthrough], [initialize: fn(_engine, _type) -> {:ok, %{status: :init, type: game_type, board: %{}, x: nil, o: nil}} end] do
